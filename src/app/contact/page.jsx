...
const ContactSection = () => {
  ...
  return (
    <div className="min-h-screen text-white" ref={sectionRef}>
      {/* Contact Header */}
      <div
        className="h-48 flex items-center justify-between px-4 sm:px-14 border-t border-b border-gray-500 bg-[#252525]"
        ref={addToRefs}
      >
        <div className="container mx-auto flex items-center justify-between px-4 sm:px-8 lg:px-14 h-20">
          ...
          <a
            href="#get-in-touch"
            className="text-gray-400 text-sm sm:text-lg hover:text-white transition-colors duration-200"
          >
            Get in Touch
          </a>
        </div>
      ...
      {/* Google Map Embed */}
      <div
        className="mt-8 px-4 sm:px-14 py-10 container mx-auto"
        ref={addToRefs}
      >
        <iframe
...
const ContactPage = () => {
  ...
  return (
    <div>
      ...
      {/* Main Content */}
      <div
        className="max-w-screen-xl container mx-auto grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-16 sm:px-0 px-4 py-3"
        ref={sectionRef}
      >
        ...
        <div className="" ref={addToRefs}>
          <h2
            className="text-2xl sm:text-2xl font-semibold mb-8"
            ref={sectionRef}
          >
            How Can I Help You?
            <div className="relative mb-8">
              ...
              {/* Blue line */}
              <div className="w-60 h-0.5 bg-gray-600 mt-1"></div>{" "}
              {/* Gray line */}
            </div>
          </h2>
