...
const ContactSection = () => {
  return (
    <div className="min-h-screen text-white">
      {/* Contact Header */}
      <div className="h-48 flex items-center justify-between px-4 sm:px-14 border-t border-b border-gray-500">
      ...
      {/* Google Map Embed */}
      <div className="mt-8 px-4 sm:px-14 py-10">
        <iframe
...
const ContactPage = () => {
  return (
    <div>
      ...
      {/* Main Content */}
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-16 mt-10 sm:px-0 px-4 py-3">
