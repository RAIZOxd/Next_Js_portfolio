...
const PortfolioSection = () => {
  ...
  return (
    <div className="min-h-screen text-white" ref={sectionRef}>
      ...
      {/* Filter Options */}
      <div className="container mx-auto mt-8 flex flex-wrap justify-center sm:justify-end space-x-4 sm:space-x-6 text-gray-400 text-base sm:text-lg px-16" ref={addToRefs}>
      ...
      <div className="container mx-auto mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 px-14 py-3" ref={addToRefs}>
